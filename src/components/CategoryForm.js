...
// this is the form that displays when you go to create a category as well as editing a category
function CategoryForm({ setCategories, categoryObject }) { // if a category object is passed through then it knows that we are editing and will adjust the form
